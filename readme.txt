...
* Slideshows: BoldR Lite comes with an additional custom post type called "Slides". You can add and edit slides just like you would do with posts or pages. Each slide can have a title (for your own reference as this won't be displayed on the front-end), a featured image (the actual slide), and optionally a link URL to make it clickable and one or several categories if you want to organize them to create multiple slideshows. Slide images are recommended to be at least 920px width and any height, though it is highly recommended that your slides have all the same height for best results.
